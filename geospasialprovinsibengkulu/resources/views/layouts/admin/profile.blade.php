...
<div class="bg-gradient-to-br from-red-50 via-white to-red-50 min-h-screen p-4 md:p-8">
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <form
            action="{{ route('admin.updateProfile', $user->user_id) }}"
            method="POST"
        ...
        >
            ...
            <div class="form-section">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {{-- Email --}}
                    <div class="md:col-span-2">
                        <label class="form-label" for="email">Email Akun <span class="text-red-500">*</span></label>
                        <input
                            type="email"
                            id="email"
                            name="email"
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white border border-gray-200 text-gray-600 rounded-xl hover:bg-gray-50 transition font-medium text-sm">
