...
@section('title', 'Profil Saya - Verifikator Panel')
    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="bg-gradient-to-r from-red-800 to-[#8b0000] rounded-2xl p-6 shadow-xl text-white flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-red-100 text-sm mt-0.5">Kelola foto profil, nama, dan informasi kontak Anda</p>
            </div>
        </div>
        ...
        <form
            action="{{ route('verifikator.profile.update') }}"
            method="POST"
        ...
        >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input
                            ...
                            disabled
                        >
                        <p class="text-xs text-gray-400 mt-1"><i class="fas fa-lock"></i> Email tidak dapat diubah melalui halaman ini.</p>
                    </div>
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('verifikator.dashboard') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white border border-gray-200 text-gray-600 rounded-xl hover:bg-gray-50 transition font-medium text-sm">
