...
<head>
    ...
    <title>@yield('title', 'Geoportal Provinsi Bengkulu - Produsen Data')</title>
    ...
    <style>
        ...
        .sidebar-glass {
            /* Menggunakan warna merah gelap sesuai desain revisi geonav */
            background: #8d1919;
        ...
        <div class="flex-1 overflow-y-auto sidebar-scroll py-4">
            <nav class="px-3 space-y-1">
                ...
                <a href="{{ route('produsen.dashboard') }}"
                   ...
                   {{ Request::routeIs('produsen.dashboard') ? 'menu-active bg-white/10 text-white' : 'hover:bg-white/10 text-red-200' }}">
                    <i class="fas fa-tachometer-alt w-5"></i>
                    <span class="font-medium">Dashboard</span>
                </a>

                <a href="{{ route('produsen.geospasial.index') }}"
                   class="menu-item flex items-center gap-3 px-4 py-3 rounded-lg
                   {{ Request::routeIs('produsen.geospasial*') ? 'menu-active bg-white/10 text-white' : 'hover:bg-white/10 text-red-200' }}">
                    <i class="fas fa-layer-group w-5"></i>
                    <span class="font-medium">Kelola Data Geospasial</span>
                </a>

                <a href="{{ route('produsen.metadata.index') }}"
                   class="menu-item flex items-center gap-3 px-4 py-3 rounded-lg
                   {{ Request::routeIs('produsen.metadata*') ? 'menu-active bg-white/10 text-white' : 'hover:bg-white/10 text-red-200' }}">
        ...
        <header class="h-[72px] topbar-glass flex items-center px-8 sticky top-0 z-30">
            ...
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-xl font-bold">
                    @yield('page-title', 'Panel Produsen Data')
                </h2>
            </div>
        </header>
